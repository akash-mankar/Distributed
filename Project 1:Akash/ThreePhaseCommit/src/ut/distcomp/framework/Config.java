...
public class Config {
	...
	public Config(String filename) throws FileNotFoundException, IOException {
        ...
        delay = loadLong(prop, "delay");
        precommitCount = loadInt(prop, "precommitCount");
        commitCount = loadInt(prop, "commitCount");
        String deathAfter = prop.getProperty("deathAfter".trim());
        String[] temp =  deathAfter.split(",");
        deathAfter_n =  Integer.parseInt(temp[2]);
        deathAfter_src =  Integer.parseInt(temp[1]);
        deathAfter_dest = Integer.parseInt(temp[0]);
	}
    ...
    private long loadLong(Properties prop, String s) {
        return Long.parseLong(prop.getProperty(s.trim()));
    }
    ...
    public int precommitCount;

    public int commitCount;

    public int deathAfter_dest;
    public int deathAfter_n;
    public int deathAfter_src;
}
